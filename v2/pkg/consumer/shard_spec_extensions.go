...
func (m *ApplyRequest_Change) Validate() error {
	if (m.Upsert == nil && m.Delete == "") || (m.Upsert != nil && m.Delete != "") {
		return pb.NewValidationError("exactly one of Upsert or Delete must be set")
	} else if m.Upsert != nil {
		if err := m.Upsert.Validate(); err != nil {
